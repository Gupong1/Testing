...
Future<void> _checkForUpdates() async {
  ...
  try {
    final response = await Dio().get(
      'http://console.jhonaleystore.id:2638/api/check-update',
      queryParameters: {
...
Future<void> _fetchHadith() async {
  ...
  try {
    ...
    final res = await http.get(
      Uri.parse("http://console.jhonaleystore.id:2638/hadith/muslim?page=$randomPage&limit=10"),
...
Future<void> _fetchAdvancedStats({int retryCount = 3}) async {
  ...
  try {
    final uri = Uri.parse(
      "$baseUrl/api/stats/real-time?key=$sessionKey",
    );
...
Future<void> _fetchNotifications() async {
  ...
  try {
    ...
    final uri = Uri.parse("$baseUrl/notify/list")
...
void _connectToWebSocket() {
  try {
    ...
    channel = WebSocketChannel.connect(
      Uri.parse('ws://console.jhonaleystore.id:2638/ws'),
  ...
  final List<Map<String, dynamic>> menuOptions = [
    {
      ...
      'features': ['Mudah digunakan', 'Function terbaru', 'All work gacor', 'NIGHT BUG'],
...
Widget _buildFeatureItem(String text, IconData icon) {
  ...
  try {
    final uri = Uri.parse(
      "$baseUrl/mySender?key=$sessionKey",
    );
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                _buildSocialButton(
                                  ...
                                  label: "TikTok",
                                  url: 'https://www.tiktok.com/@zalstecu23',
                                ),
  ...
  onTap: () {
    Navigator.push(
      ...
      MaterialPageRoute(builder: (context) => ThanksToPage()),
                            ...
                            SizedBox(height: 20),
                            Text(
                              "Selalu nantikan project terbaru dari TEAM NIGHT",
                              textAlign: TextAlign.center,
                              style: TextStyle(
                                color: Colors.white.withOpacity(0.6),
                                fontSize: 14,
